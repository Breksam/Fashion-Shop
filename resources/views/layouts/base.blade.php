...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Fashion Shop">
    ...
    <meta name="author" content="Fashion Shop">
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{ route('app.index') }}">
                                        <img src="{{ asset('assets/images/logo.png') }}" alt="logo" class="h-logo img-fluid blur-up lazyload">
                                    </a>
                                </div>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route('app.about') }}" class="nav-link menu-title">About Us</a></li>
                                            <li><a href="{{ route('app.contact') }}" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                        ...
                                        <div class="cart-media">
                                            <a href="{{ route('cart.index') }}">
                                                ...
                                                <span id="cart-count" class="label label-theme rounded-pill">
                                                    {{ App\Models\Cart::where([['user_id', Auth::id()], ['status', 'Pending']])->get()->count() }}
                                                </span>
                                            </a>
                                        </div>
                                    </li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@fashionshop.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('app.about') }}" class="font-dark">About Us</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('app.contact') }}" class="font-dark">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{ route('user.index') }}" class="font-dark">Your Account</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('cart.index') }}" class="font-dark">Your Cart</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('wishlist') }}" class="font-dark">Your Wishlist</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
